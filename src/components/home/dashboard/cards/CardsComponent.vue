<template>
    <ul
        ...
        <CardComponent v-for="(card, index) in cards" :key="index" :title="card.title" :category="card.category" />
    </ul>
</template>
    ...
    data() {
        return {
            cards: [
                ...
                { title: 'ETravelGuide', category: 'Se Cayó ):' },
                { title: 'Prueba', category: 'Otra Categoria' }
            ]
        };
    }
};
