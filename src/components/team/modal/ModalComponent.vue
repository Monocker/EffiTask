    ...
    async submitForm() {
      ...
      try {
        ...
        <div style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #ECECEC; border-radius: 10px; text-align: center; color: #333;">
          ...
          <a href="http://localhost:5173/validate?token=${token}&collaboratorId=${newCollaboratorId}&fullName=${this.fullName}" style="background-color: #4A90E2; color: white; padding: 15px 30px; border-radius: 5px; text-decoration: none; display: inline-block; font-weight: bold;">Confirmar tu dirección de correo</a>
