        ...
        <div class="relative p-5 w-full max-w-md mx-4 sm:mx-auto rounded-md bg-white shadow-lg">
            <div class="text-center">
                ...
                <div class="mt-2">
                    ...
                    <select v-model="selectedDepartment" v-if="isEditable" class="mt-2 p-2 w-full border rounded">
                        <option v-for="department in userDepartments" :key="department" :value="department">
                            {{ department }}
                        </option>
                    </select>
...
export default {
    ...
    data() {
        return {
            isEditable: false,
            editablePerson: {},
            userDepartments: [], // Lista de departamentos del usuario logeado
            selectedDepartment: '',
        };
    },
    watch: {
    ...
    methods: {
        ...
        async fetchUserDepartments() {
            ...
            if (user) {
                ...
                if (userDoc.exists()) {
                    this.userDepartments = userDoc.data().departments || [];
                } else {
        ...
        async updateColaborador() {
            try {
                ...
                await updateDoc(colaboradorRef, {
                    ...
                    departmentArea: this.selectedDepartment,
